...
@Component({
  selector: 'app-pickup-queue',
  standalone: true,
  imports: [CommonModule, RouterLink, PaginationComponent],
  templateUrl: './pickup-queue.component.html',
  styleUrl: './pickup-queue.component.scss'
})
export class PickupQueueComponent implements OnInit {
